<template>
  <footer class="bg-gray-900 dark:bg-gray-950 text-white transition-colors">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-gray-300 dark:text-gray-400 mb-4 max-w-md">
            {{ t('footer.description') }}
          </p>
          <div class="flex space-x-4">
            <a
              href="#"
              class="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors"
            >
      ...
      >
        <p class="text-gray-300 dark:text-gray-400 text-sm">
          © {{ currentYear }} 👨🏻‍💻Codevaper. {{ t('footer.allRightsReserved') }}.
        </p>
        <div class="flex space-x-6 mt-4 md:mt-0">
          <a
            href="#"
            class="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 text-sm transition-colors"
          >
...
import { HomeIcon, PhoneIcon, EnvelopeIcon, MapPinIcon } from '@heroicons/vue/24/outline'
